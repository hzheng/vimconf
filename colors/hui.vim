...
" Based on lucius Version3.1 (http://www.vim.org/scripts/script.php?script_id=2536)
...
hi StatusLine       guifg=#e0e0e0           guibg=blue              gui=bold
hi StatusLine       ctermfg=254             ctermbg=237             cterm=bold

" status line for non-current windows
hi StatusLineNC     guifg=#767986           guibg=gray              gui=none
